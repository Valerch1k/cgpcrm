        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    {!! Form::open(['url' => '/client/edit/'. $client->id,'method' => 'post']) !!}
                    {{ csrf_field() }}
                        ...
                        {!! Form::select('company_id', $companies,$client->company_id, ['class' => 'select-company form-control']) !!}

                        {!! Form::label('Shipping address', 'Shipping address', ['class' => 'grey-text']) !!}
                        {!! Form::text('shipping_address',$client->shipping_address,['class' => 'form-control']); !!}

                        {!! Form::label('Billing address', 'Billing address', ['class' => 'grey-text']) !!}
                        {!! Form::text('billing_address',$client->billing_address,['class' => 'form-control']); !!}
